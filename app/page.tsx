const NATIVE_SCRIPT_URL = 'https://pl31358482.profitableratecpmnetwork.com/2ca2e27c0af302fa34b9d19a55d778ee/invoke.js'
const NATIVE_CONTAINER_ID = 'container-2ca2e27c0af302fa34b9d19a55d778ee'
  ...
  return (
    <>
      <div className="desktop-ad">
        ...
        />
        <script src="https://www.highrevenueformat.com/410caa64d80169384e63102757efaa6d/invoke.js" />
      </div>
  ...
  return (
    <>
      <div className="desktop-ad">
        ...
        />
        <script src="https://www.highrevenueformat.com/ce461342d57fce5a083abac0b63336f9/invoke.js" />
      </div>
...
#${NATIVE_CONTAINER_ID}{width:100%;height:100%;min-height:100%;overflow:hidden}
</style>
</head>
<body>
<div id="${NATIVE_CONTAINER_ID}"></div>
<script async data-cfasync="false" src="${NATIVE_SCRIPT_URL}"></script>
</body>
</html>`

  return (
    <div className={`native-frame native-${orientation}`}>
      <iframe
        title={horizontal ? 'Native horizontal advertisement' : 'Native vertical advertisement'}
        srcDoc={srcDoc}
        frameBorder="0"
        scrolling="no"
        loading={horizontal ? 'lazy' : 'eager'}
...
function Banner160x600() {
  return (
    <div className="vertical-ad">
      ...
      />
      <script src="https://www.highrevenueformat.com/990b50bbcdf8de02a82fd364d458a2d6/invoke.js" />
    </div>
  )
}
...
function Banner160x300() {
  return (
    <div className="vertical-ad">
      ...
      />
      <script src="https://www.highrevenueformat.com/c2c0b3d9a3c7cfcd487d8c9fd755fc63/invoke.js" />
    </div>
  )
}
    ...
    <main>
      ...
      <div className="wrap hero">
        <div className="hero-copy">
          ...
          {/* =======================================================
              WIDE AD 2 — DIRECTLY BELOW TITLE
              Desktop: 468x60
              Mobile: 320x50
              ======================================================= */}
          <div className="hero-title-ad live-ad">
            <Banner468x60 />
          </div>
      ...
      <div className="wrap content-grid">
        <article className="article">
          ...
          {/* =====================================================
              WIDE AD 4 — BETWEEN PERSONAL FINANCE AND BANKING
              Desktop: 728x90
              Mobile: 320x50
              ===================================================== */}
          <div className="mid-ad live-ad">
          ...
          {/* =====================================================
              ...
              Format: 4:1 horizontal
              ===================================================== */}
          <div className="native-horizontal-placement native-mid-placement">
            <NativeAdFrame orientation="horizontal" />
          </div>
          ...
          {/* =====================================================
              WIDE AD 9 — FINAL ARTICLE POSITION
              Desktop: 728x90
              Mobile: 320x50
              ===================================================== */}
          ...
          {/* =====================================================
              NATIVE AD — END OF ARTICLE
              Format: 4:1 horizontal
              ===================================================== */}
          <div className="native-horizontal-placement native-end-placement">
            <NativeAdFrame orientation="horizontal" />
          </div>
        </article>
        ...
        <aside className="sidebar">
          <div className="sticky-sidebar">
            {/* =====================================================
                NATIVE 1:4 — NORMAL RIGHT-SIDE AD
                Outside article, inside sidebar
                ===================================================== */}
            <div className="native-sidebar-vertical">
              <div className="sidebar-ad-label">ADVERTISEMENT</div>
              <NativeAdFrame orientation="vertical" />
            </div>

            {/* Other ad type — 160x600 */}
            <Banner160x600 />
      ...
      {/* =========================================================
          NATIVE 1:4 — FIXED RIGHT-SIDE AD
          Desktop only; remains fixed while scrolling
          ========================================================= */}
      <div className="fixed-native-ad">
        <div className="fixed-native-label">ADVERTISEMENT</div>
        <NativeAdFrame orientation="vertical" />
      </div>
